...
Purpose
-------
It's easiest to describe The MozDef Event Framework as a set of micro-services you can use to integrate event sources with the _Mozilla Enterprise Defense platfrorm: https://mozdef.readthedocs.io/en/latest/ (MozDef).
